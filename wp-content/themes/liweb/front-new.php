...
<div id="anchor-about" class="pi-section-w pi-section-white">
            <div class="pi-section pi-padding-top-90 pi-padding-bottom-30">
                <div class="pi-text-center pi-padding-bottom-40">
                    <h6 class="pi-uppercase pi-letter-spacing-3 pi-text-base pi-margin-bottom-15">About</h6>
                    <h2 class="h1 pi-weight-700 pi-uppercase pi-has-border pi-has-tall-border pi-has-short-border">Who We Are</h2>
                </div>
                <div class="pi-row">
                    <div class="pi-col-sm-6 pi-padding-bottom-50">
                        <div class="pi-slider-wrapper pi-slider-arrows-inside pi-slider-show-arrow-hover">
                            <div class="pi-slider pi-slider-animate-opacity">
                                ...
                                <div class="pi-slide">
                                    <div class="pi-img-w pi-img-round-corners pi-img-shadow pi-img-with-overlay">
                                        <a href="#"><img src="http://localhost:8080/liweb/wp-content/themes/liweb/img_external/gallery/team-photo.jpg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pi-col-sm-6 pi-padding-bottom-50">
                        <p class="lead-26 pi-weight-300 pi-text-base pi-margin-top-minus-10">Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus.</p>
                        <p class="pi-margin-bottom-30">Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo facilis est et expedita distinctio minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Facilis facere possimus, omnis voluptas rerum necessitatibus saepe eveniet.</p>
                        <h5 class="pi-uppercase pi-weight-700">Core Values:</h5>
                        <div class="pi-row">
    ...
    <div class="pi-section-w pi-section-parallax" style="background-image: url(http://localhost:8080/liweb/wp-content/themes/liweb/img_external/gallery/modern-skyscraper.jpg)">
            ...
            <div class="pi-section pi-padding-top-50 pi-padding-bottom-20">
                <div class="pi-text-center pi-padding-bottom-20">
                    <h6 class="pi-uppercase pi-letter-spacing-3">Some Numbers</h6>
                </div>
                <div class="pi-row pi-grid-small-margins pi-text-center">
                    <div class="pi-col-sm-3 pi-col-2xs-6 pi-padding-bottom-20">
                        <div class="pi-counter pi-counter-simple" data-count-from="0" data-count-to="230" data-easing="easeInCirc" data-duration="1000" data-frames-per-second="0">
                            ...
                            <p class="lead-18">Magnam aliquam</p>
                        </div>
                    </div>
                    <div class="pi-col-sm-3 pi-col-2xs-6 pi-padding-bottom-20">
                        <div class="pi-counter pi-counter-simple" data-count-from="0" data-count-to="26" data-easing="easeInCirc" data-duration="2000" data-frames-per-second="10">
                            ...
                            <p class="lead-18">Deserunt mollitia animi</p>
                        </div>
                    </div>
                    <div class="pi-col-sm-3 pi-col-2xs-6 pi-padding-bottom-20">
                        <div class="pi-counter pi-counter-simple" data-count-from="0" data-count-to="73" data-easing="easeInCirc" data-duration="3000" data-frames-per-second="10">
                            ...
                            <p class="lead-18">Temporibus autem</p>
                        </div>
                    </div>
                    <div class="pi-col-sm-3 pi-col-2xs-6 pi-padding-bottom-20">
                        <div class="pi-counter pi-counter-simple" data-count-from="0" data-count-to="59" data-easing="easeInCirc" data-duration="4000" data-frames-per-second="10">
                            ...
                            <p class="lead-18">Similique sunt in culpa</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="anchor-services" class="pi-section-w pi-section-white">
            <div class="pi-section pi-padding-top-90 pi-padding-bottom-60">
                <div class="pi-text-center pi-padding-bottom-40">
                    <h6 class="pi-uppercase pi-letter-spacing-3 pi-text-base pi-margin-bottom-15">Services</h6>
                    <h2 class="h1 pi-weight-700 pi-uppercase pi-has-border pi-has-tall-border pi-has-short-border">What We Offer</h2>
                </div>
                <div class="pi-row">
                    <div class="pi-col-xs-6 pi-col-sm-4 pi-padding-bottom-40">
                        <div class="pi-icon-box pi-icon-box-hover pi-icon-box-icon-big">
                            ...
                            <div class="pi-icon-box-content-2">
                                ...
                                <p class="pi-margin-bottom-10">Sed ut perspiciatis unde omnis iste natus error sit voluptatem</p>
                            </div>
                        </div>
                    </div>
                    <div class="pi-col-xs-6 pi-col-sm-4 pi-padding-bottom-40">
        ...
        <div id="anchor-team" class="pi-section-w pi-section-white piSocials">
            <div class="pi-section pi-padding-top-90 pi-padding-bottom-30">
                <div class="pi-text-center pi-padding-bottom-20">
                    ...
                    <h2 class="h1 pi-weight-700 pi-uppercase pi-has-border pi-has-tall-border pi-has-short-border">Meet The Team</h2>
                ...
                <div class="pi-row">
                    <div class="pi-col-xs-6 pi-col-sm-3 pi-padding-bottom-40 pi-text-center">
                        ...
                        <h5 class="pi-uppercase pi-weight-700 pi-margin-bottom-5 pi-letter-spacing">Mike Ross</h5>
                        <p class="pi-italic pi-text-base pi-margin-bottom-10">Co-Founder, Art Director</p>
                        <p class="pi-margin-bottom-10">Leveraging our collective experience, we create extraordinary elegant solutions</p>
                    ...
                    <div class="pi-col-xs-6 pi-col-sm-3 pi-padding-bottom-40 pi-text-center">
                        ...
                        <h5 class="pi-uppercase pi-weight-700 pi-margin-bottom-5 pi-letter-spacing">Mattias Nuffer</h5>
                        <p class="pi-italic pi-text-base pi-margin-bottom-10">Co-Founder, Web Developer</p>
                        <p class="pi-margin-bottom-10">Leveraging our collective experience, we create extraordinary elegant solutions</p>
                        <ul class="pi-social-icons pi-jump pi-small pi-round pi-colored-bg clearFix">
                            <li><a href="#" class="pi-social-icon-facebook"><i class="icon-facebook"></i></a></li>
                            <li><a href="#" class="pi-social-icon-twitter"><i class="icon-twitter"></i></a></li>
                    ...
                    <div class="pi-col-xs-6 pi-col-sm-3 pi-padding-bottom-40 pi-text-center">
                        ...
                        <h5 class="pi-uppercase pi-weight-700 pi-margin-bottom-5 pi-letter-spacing">Kindra Hall</h5>
                        <p class="pi-italic pi-text-base pi-margin-bottom-10">Web & Graphic Designer</p>
                        <p class="pi-margin-bottom-10">Leveraging our collective experience, we create extraordinary elegant solutions</p>
                        <ul class="pi-social-icons pi-jump pi-small pi-round pi-colored-bg clearFix">
                            <li><a href="#" class="pi-social-icon-twitter"><i class="icon-twitter"></i></a></li>
                            <li><a href="#" class="pi-social-icon-dribbble"><i class="icon-dribbble"></i></a></li>
                    ...
                    <div class="pi-col-xs-6 pi-col-sm-3 pi-padding-bottom-40 pi-text-center">
                        ...
                        <h5 class="pi-uppercase pi-weight-700 pi-margin-bottom-5 pi-letter-spacing">Nora Anderson</h5>
                        <p class="pi-italic pi-text-base pi-margin-bottom-10">Project Manager</p>
                        <p class="pi-margin-bottom-10">Leveraging our collective experience, we create extraordinary elegant solutions</p>
                        <ul class="pi-social-icons pi-jump pi-small pi-round pi-colored-bg clearFix">
        ...
        <div id="anchor-testimonials" class="pi-section-w pi-section-parallax pi-slider-enabled" style="background-image: url(http://localhost:8080/liweb/wp-content/themes/liweb/img_external/gallery/consulting.jpg)">
            ...
            <div class="pi-section pi-padding-top-70 pi-padding-bottom-70">
                <div class="pi-text-center pi-padding-bottom-20">
                    <h6 class="pi-uppercase pi-letter-spacing-3 pi-margin-bottom-15">Testimonials</h6>
                </div>
                        ...
                        <div class="pi-row">
                            <div class="pi-col-sm-10 pi-col-sm-offset-1">
                                <div class="pi-slide">
                                    ...
                                    <p class="lead-32 pi-text-white pi-text-shadow pi-italic"><i class="icon-quote pi-text-base pi-icon-left"></i>Corrupti quos dolores et quas molestias excepturi at vero eos et accusamus et iusto odio dignis.<i class="icon-quote pi-text-base pi-icon-right"></i></p>
                    ...
                    <div class="pi-col-md-4 pi-col-sm-6 pi-padding-bottom-30">
                        ...
                        <div class="pi-section-w pi-section-white">
                            <div class="pi-google-map pi-google-map-wide googleMap" style="height: 200px">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.2884922463527!2d106.68517831471448!3d10.789202261908253!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f2d50100ddd%3A0x4a1e1ee5aaddbdbc!2zQ8O0bmcgdHkgQ-G7lSBwaOG6p24gRHUgbOG7i2NoIEFwZXggVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1455867954785" width="100%" height="100%" frameborder="0" style="border:0" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
